...
<?php $this->beginPage() ?>
    ...
    <div class="row">
        <div class="line-wrapper">
            <div class="col-xs-12 col-sm-9 col-sm-push-3 footer-nav">
                <div class="col-xs-12">
                    <nav class="navbar-default">
                        <ul class="nav navbar-nav">

                            <li class="{% if active_page == 'main' %}active{% endif %}">
                                <a href="/">Главная</a>
                            </li>
                            ...
                            <li class="{% if active_page == 'portfolio' %}active{% endif %}">
                                <a href="/portfolio/">Портфолио</a>
                            </li>
                ...
                <div class="col-xs-12 footer-contacts">
            ...
            <div class="col-xs-12 col-sm-3 col-sm-pull-9 ls-copy">
                <div class="col-xs-12 ls-copy-italic">
                    &copy 108LABS.COM, 2015
                </div>
