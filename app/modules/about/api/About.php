...
/**
 * News module API
 * @package app\modules\about\api
 *
 * @method static AboutObject get(mixed $id_slug) Get news object by id or slug
...
class About extends \yii\easyii\components\API
{
    private $_adp;
    private $_last;
    private $_items;
    ...
    public function api_items($options = [])
    {
        if(!$this->_items){
            ...
            $with = ['seo'];
            if(Yii::$app->getModule('admin')->activeModules['about']->settings['enableTags']){
                $with[] = 'tags';
            }
            ...
            foreach($this->_adp->models as $model){
                $this->_items[] = new AboutObject($model);
            }
        }
        return $this->_items;
    }
