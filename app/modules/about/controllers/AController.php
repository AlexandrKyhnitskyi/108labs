...
use app\modules\about\models\News;
...
class AController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if(isset($_FILES) && $this->module->settings['enableThumb']){
                    ...
                    if($model->image && $model->validate(['image'])){
                        $model->image = Image::upload($model->image, 'about');
                    }
                    else{
                        $model->image = '';
                    }
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('easyii/about', 'News created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('easyii/about', 'News updated'));
                }
                else{
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('easyii/about', 'News deleted'));
    }
